...
prose is never the only location of a safety rule. These ten are the compact
paper view; the generated registry and closure plan remain the authoritative
crosswalk~\cite{bulletRegistry,bulletClosure}.
...
configuration digest is re-pinned in the model lock~\cite{bulletFormal}. An
